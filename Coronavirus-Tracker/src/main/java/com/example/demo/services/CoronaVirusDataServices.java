...
public class CoronaVirusDataServices 
{
	...
	private static String VIRUS_DATA_URL="https://raw.githubusercontent.com/cCOVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv";
	@PostConstruct
	@Scheduled(cron = "* * * 1 * *")
